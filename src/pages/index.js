...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>
          Vasundhara Pure G20 peanuts Oils | 100% Natural & Chemical-Free
        </title>
        <meta
          name="description"
          content="Buy premium cold-pressed groundnut oil, coconut oil, sesame oil, and more. 100% pure, fresh, and chemical-free oils trusted by 5,00,000+ families across India."
        />
        <meta
          name="keywords"
      ...
      <main className="w-full bg-yellow-100 overflow-hidden">
          ...
          <div className="marquee">
            <div className="track">
              <p className="text-xl md:text-2xl font-semibold text-gray-900">
                ...
                by 5,00,000+ Families • Premium Quality You Can Taste ★
              </p>
              <p className="text-xl md:text-2xl font-semibold text-gray-900">
        ...
        >
          ...
          >
            ...
            precision. Our mission is to deliver freshness, quality, and trust
            in every product.
          </p>
          ...
          <div className="px-4 sm:px-6 md:px-0 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12 items-center w-full">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                At{" "}
                <span className="font-semibold text-primary">Vasundhara</span>,
